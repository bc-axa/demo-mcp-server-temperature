...
public class WeatherService {
    ...
    private static final String API_REQUEST_PARAMS = "?latitude=%f&longitude=%f&hourly=temperature_2m&forecast_days=1&format=json&timeformat=unixtime";
    ...
    public WeatherResponse getWeather(double latitude, double longitude) {
        String url = String.format(API_URL + API_REQUEST_PARAMS, latitude, longitude);
        log.info(url);
